...
Spruce.store('theme', {
  ...
  change: function change() {
    if (this.isDarkMode == false) {
      this.isDarkMode = true; // document.documentElement.classList.add('mode-dark');
      ...
      this.isDarkMode = false; // document.documentElement.classList.remove('mode-dark');
...
__webpack_require__(/*! /home/firemans/project/wedku/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/firemans/project/wedku/resources/css/app.css */"./resources/css/app.css");
